    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-6 gap-3">
            <div>
                ...
                <p class="text-body-secondary mb-0">Perbarui informasi layanan <strong>{{ $service->name_service }}</strong></p>
            </div>
        ...
        <div class="row">
                        ...
                        <form method="POST" action="{{ route('service.update', $service) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="description_service" name="description_service" rows="3"
                                    ...
                                    placeholder="Deskripsi singkat layanan...">{{ old('description_service', $service->description_service) }}</textarea>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="price_service" name="price_service"
                                            ...
                                            value="{{ old('price_service', $service->price_service) }}"
                                ...
                                <div class="col-sm-6">
                                    <label for="stock_service" class="form-label">Stock <span class="text-danger">*</span></label>
                                    <input type="number" id="stock_service" name="stock_service"
                                        class="form-control @error('stock_service') is-invalid @enderror bg-light"
                                        value="{{ old('stock_service', $service->stock_service) }}"
                                        min="0" max="32767" readonly required>
                                    @error('stock_service')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-body-secondary">Ubah stock lewat menu Stock Masuk/Keluar untuk riwayat tercatat.</small>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-start gap-4 flex-wrap">
                                    ...
                                    <div id="imagePreviewWrapper"
                                        ...
                                        @if ($service->image_service)
                                            <img id="imagePreview"
                                                src="{{ asset('storage/' . $service->image_service) }}"
                                                alt="{{ $service->name_service }}"
                                                style="width: 100%; height: 100%; object-fit: cover;">
                                            <div id="imagePlaceholder" class="text-center text-body-secondary p-2" style="display: none;">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <button type="button" id="btnRemoveImage"
                                            class="btn btn-sm btn-label-danger mt-2"
                                            style="{{ $service->image_service ? '' : 'display: none;' }}"
                                            onclick="removeImage()">
                                            <i class="bx bx-x me-1"></i>Hapus Gambar
                                        </button>
                                        {{-- Hidden: tandai gambar dihapus --}}
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-header">
                        <h6 class="card-title mb-0"><i class="bx bx-time me-2 text-warning"></i>Info Layanan</h6>
                    </div>
                    <div class="card-body small text-body-secondary">
                        ...
                        <div>
                            ...
                            {{ $service->updated_at->translatedFormat('d M Y H:i') }}
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title mb-0"><i class="bx bx-info-circle me-2 text-info"></i>Catatan</h6>
                    </div>
                    <div class="card-body small text-body-secondary">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-2"><i class="bx bx-check text-success me-1"></i>Upload gambar baru otomatis menggantikan gambar lama.</li>
                            <li class="mb-0"><i class="bx bx-info-circle text-warning me-1"></i>Perubahan stock disarankan melalui menu Stock Masuk/Keluar agar riwayat tercatat.</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    ...
    imageInput.addEventListener('change', function () {
        ...
        // Reset flag hapus jika upload baru
        removeFlag.value = '0';
